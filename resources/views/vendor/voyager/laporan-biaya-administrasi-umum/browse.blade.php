            ...
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        ...
                        @php
                            $total_BiayaAdministrasiUmum = $BiayaAdministrasiUmum->whereNull('ended_at')->whereIn('company_parent_id', [3])->get();
                            ...
                            $adm2018 = collect([$total_BiayaAdministrasiUmum])->sum(function ($total_BiayaAdministrasiUmum){
                                ...
                                $adm2019 = collect([$total_BiayaAdministrasiUmum])->sum(function ($total_BiayaAdministrasiUmum){
                                    return $total_BiayaAdministrasiUmum->sum('tahun2');
                                });

                                $adm2020 = collect([$total_BiayaAdministrasiUmum])->sum(function ($total_BiayaAdministrasiUmum){
                                    return $total_BiayaAdministrasiUmum->sum('tahun3');
                                });

                                $ADMTAHUN = collect([$total_BiayaAdministrasiUmum])->sum(function ($total_BiayaAdministrasiUmum){
                                    return $total_BiayaAdministrasiUmum->sum('total_biaya_lp_adm');
                                });
                        @endphp
                        <br/>
                        <div class="panel panel-bordered">
                            <div class="panel-body">
                                <div class="pull-left">
                                    <div class="col-2">
                                        <label for="total PPJ" >Total Biaya Laporan ADM. tahun 2018 :</label> <span class="badge badge-success">Rp {{number_format($adm2018, 0, ".", ".")}}</span>
                                    </div>
                                    <div class="col-2">
                                        <label for="total PPJ" >Total Biaya Laporan ADM. tahun 2019 :</label> <span class="badge badge-success">Rp {{number_format($adm2019, 0, ".", ".")}}</span>
                                    </div>
                                    <div class="col-2">
                                        <label for="total PPJ" >Total Biaya Laporan ADM. tahun 2020 :</label> <span class="badge badge-success">Rp {{number_format($adm2020, 0, ".", ".")}}</span>

                                        {{-- <label for="total PPJ" class="badge badge-success">Total Biaya ADM. perbulan :</label> <span class="">Rp {{number_format($ADMBULAN, 0, ".", ".")}}</span> --}}
                                    </div>
                                    <div class="col-2">
                                        <label for="total PPJ" >Total Biaya Laporan Biaya / Perbulan :</label> <span class="badge badge-success">Rp {{number_format($ADMTAHUN, 0, ".", ".")}}</span>
