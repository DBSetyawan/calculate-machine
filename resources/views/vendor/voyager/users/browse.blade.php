...
@section('page_header')
    <div class="container-fluid">
        ...
        @can('add', app($dataType->model_name))
            <a href="{{ route('voyager.'.$dataType->slug.'.created') }}" class="btn btn-success btn-add-new">
                <i class="voyager-plus"></i> <span>{{  __('voyager::generic.add') }} </span>
            </a>
        @endcan
    ...
    <div class="alert alert-error alert-name-errors" role="alert">
