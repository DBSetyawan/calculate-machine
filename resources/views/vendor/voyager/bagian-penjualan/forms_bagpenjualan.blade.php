            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <input type="text" class="form-control" id="total_bag_penjualan" name="total_bag_penjualan" placeholder="">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('form').submit(function(event) {
                ...
                $.ajax({
                    type        : 'POST',
                    url         : "{{ route('bg.pnjualan.store.master') }}", 
                    data        : formData, 
                    dataType    : 'json', 
                    encode          : true
                })
                .done(function(data) {
                    $("#total_bag_penjualan").val(data.total_biaya_perbulan_bpenjualan);
