...
@section('page_header')
    <div class="container-fluid">
        ...
        @endcan
        <a href="{{ route('account.mtc.form.master') }}" class="btn btn-success btn-add-new">
            <i class="voyager-plus"></i> <span>{{ __('voyager::generic.add_new') }} Account MTC</span>
        </a>
                                        ...
                                        @foreach($dataType->browseRows as $row)
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    ...
                                                    @if ($row->display_name == 'Biaya / Bulan')
                                                        <span>{{ "Rp " . number_format($data->biaya_perbulan,0,',','.') }}</span>
                                                    @endif
