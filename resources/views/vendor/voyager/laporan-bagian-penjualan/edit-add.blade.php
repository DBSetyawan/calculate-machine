    ...
    <form class="form-edit-add" role="form"
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="panel panel-bordered">
                <div class="panel-body">
                    <h3>Laporan biaya Bagian Penjualan</h3>
                    <div class="row">
                        <div class="col-md-12">
                            <span>Total Biaya Bagian Penjualan Perbulan</span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
    ...
    $('document').ready(function () {
        ...
        $('.save').click(function(event) {
            ...
            event.preventDefault();
                    ...
                    Swal.fire({
                        title: 'Informasi',
                        text: 'Apakah anda ingin mengakumulasi biaya perhitugan biaya bagian penjualan sekarang?',
                    ...
                    $.ajax({
                        type        : 'POST',
                        url         : "{{ route('lp.biaya.adminitrasi.umum.changedbagianpenjualan') }}", 
                        data        : store, 
                        dataType    : 'json', 
                        encode      : true
                    })
