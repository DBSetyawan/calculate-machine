...
use App\Http\Controllers\KOP\Helpers\RumusGajiLain;
use App\Http\Controllers\KOP\Service\GajinLainInterface;
use TCG\Voyager\Http\Controllers\VoyagerBaseController as BaseVoyagerBaseController;

class VoyagerGajiLainController extends BaseVoyagerBaseController Implements GajinLainInterface
{

    public function RumusTotalGajiLain($gaji, $tunjangan_tetap, $tunjangan_tidak_tetap, $tunjangan_asuransi, $THR)
    {
        return RumusGajiLain::JumlahGajiLain($gaji, $tunjangan_tetap, $tunjangan_tidak_tetap, $tunjangan_asuransi, $THR);  
    }

    public function formGajiLainAction(Request $request)
    {
        $company = Company::all();
        $mesin = Mesin::all();
        $cbagian = KategoriBagian::all();

        return view('vendor.voyager.gaji-lain.forms_glain', compact('company','mesin','cbagian'));
    }

    public function HitungAkumulasiGajiLain(Request $r){

        /**
         * Total biaya labor
         */
        $total_biaya_labor = $this->RumusTotalGajiLain($r->gaji, $r->tunjangan_tetap, $r->tunjangan_tidak_tetap, $r->tunjangan_asuransi, $r->thr);
        ...
        $result_gaji_labor = [
            ...
            'tunjangan_asuransi' => $r->tunjangan_asuransi,
            'thr' => $r->thr,
            'total_biaya_labor' => $total_biaya_labor,
        ];

        $simpanDataLaporanGajiLain = GajiLain::create($result_gaji_labor);
