...
class VoyagerTotalKalkulasiController extends BaseVoyagerBaseController Implements ServiceModuleCalculates
{
    ...
    const ButtonCalcSmuaBiayaExports = "<a href='https://vpn.krisanthium.com:7070/kalkulasimesin2/public/admin/export/all-calculate-machine-xlsx-semua-total-biaya' id='cal_semua_biaya' class='btn btn-secondary csbe' style='background-color: brown;color:white'><i class='voyager-news'></i> Download Semua Biaya</a>";
