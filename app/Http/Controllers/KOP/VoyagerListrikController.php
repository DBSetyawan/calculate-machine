...
class VoyagerListrikController extends BaseVoyagerBaseController implements ListrikInterface
{
    ...
    public function RumusPemakaianLWBP($shift, $ampere, $voltase, $mesin){

        return RumusListrik::HitungLWBP($shift, $ampere, $voltase, $mesin);

    }
    
    public function RumusPemakaianWBP($shift, $ampere, $voltase, $mesin){

        return RumusListrik::HitungWBP($shift, $ampere, $voltase, $mesin);
    ...
    public function HitungAkumulasiListrik(Request $r){
         ...
         */
        $rumusLWBPerminggu = $this->RumusPemakaianLWBP($r->shift, $r->ampere, $r->voltase, $r->code_mesin);

        /**
         * Hitung WBP perminggu
         * @store append field WBP perminggu.
         */
        $rumusWBPerminggu = $this->RumusPemakaianWBP($r->shift, $r->ampere, $r->voltase, $r->code_mesin);
