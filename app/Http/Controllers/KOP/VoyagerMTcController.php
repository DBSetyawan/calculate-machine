...
class VoyagerMTcController extends BaseVoyagerBaseController Implements MTcInterface
{

    public function RmsMTCperbaikanperbulan($perbaikan_pertahun, $code_mesin){

        return RumusMaintenance::HitungPerbaikanPerbulan($perbaikan_pertahun, $code_mesin);

    }

    public function RmsMTCSparePartPerbulan($sparepart_pertahun){

        return RumusMaintenance::HitungSparePartPerbulan($sparepart_pertahun);

    }

    public function RmsMTCTotalPerbulan($perbaikan_perbulan, $spare_part_perbulan){
    ...
    public function HitungAkumulasiMaintenance(Request $r){
        ...
        $data_response_mtc = [
            ...
            'code_mtc' => RumusMaintenance::generateIDMTC(), 
            'perbaikan_pertahun' => $r->perbaikan_pertahun,
            'filter_periode' => $r->tdate,
            'perbaikan_perbulan' => $rmsperbaikanpertahun,
            'sparepart_pertahun' => $r->sparepart_pertahun,
            'sparepart_perbulan' => $rmssparepartperbulan,
            'total_perbulan' => $rumusTotalMaintenancebulanan
        ];

        $simpanBiayaListrik = Mtc::create($data_response_mtc);

        return response()->json(
            [
                'total_perbulan' => $simpanBiayaListrik->total_perbulan,
                'perbaikan_perbulan' => $simpanBiayaListrik->perbaikan_perbulan,
                'sparepart_perbulan' => $simpanBiayaListrik->sparepart_perbulan,
                // 'TestCode' => $data_response_mtc
            ]
        );

    }
    
    public function formMTCAction(Request $request)
    {
        $company = Company::all();
        $mesin = Mesin::all();
