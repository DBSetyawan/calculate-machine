...
use App\Http\Controllers\KOP\Helpers\RumusBagianPenjualan;
use App\Http\Controllers\KOP\Service\BagianPenjualanInterface;
use TCG\Voyager\Http\Controllers\VoyagerBaseController as BaseVoyagerBaseController;

class VoyagerBagianPenjualanController extends BaseVoyagerBaseController implements BagianPenjualanInterface
{

    public function RumusPenjualanPerbulan($biayapertahun)
    {
        return RumusBagianPenjualan::TotalPenjualanBagianPenjualan($biayapertahun);
    }

    public function formBagPenjualanAction(Request $request)
    {
        $company = Company::all();
        $mesin = Mesin::all();
        $cbagian = KategoriBagian::all();

        return view('vendor.voyager.bagian-penjualan.forms_bagpenjualan', compact('company','mesin','cbagian'));
    }

    public function HitungAkumulasiBagianPenjualan(Request $r){

        /**
         * Total biaya bag. penjualan
         */
        $total_biaya_upah_perbulan = $this->RumusPenjualanPerbulan($r->biaya_pertahun);
        ...
        $result_bpnjualan = [
            ...
            'code_penjualan' => RumusBagianPenjualan::generateIDBPenjualan(),
        ];

        $simpanDataLaporanGajiLain = BagianPenjualan::create($result_bpnjualan);

        return response()->json(
            [
                'total_biaya_perbulan_bpenjualan' => $simpanDataLaporanGajiLain->biaya_perbulan,
            ]
        );
