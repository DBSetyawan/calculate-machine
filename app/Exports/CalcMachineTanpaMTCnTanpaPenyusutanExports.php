    ...
    */
    public function map($calcs): array
    {
        return [
            ...
            $calcs->id_bau,
            $calcs->total_tanpa_penyusutan_n_mtc,
            $calcs->total_tanpa_penyusutan_n_mtc_perjam
        ];
    }
    ...
    public function headings(): array
    {
        return [
            ...
            'TOTAL SEMUA BIAYA TANPA PENYUSUTAN + MTC',
            'TOTAL SEMUA BIAYA TANPA PENYUSUTAN + MTC (/JAM)',
        ];
    }
