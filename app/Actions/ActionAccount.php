...
class ActionAccount extends AbstractAction
{
    ...
    public function getAttributes()
    {
        ...
        // if(Auth::user()->role->id == 3 || Auth::user()->role->id == 1 || Auth::user()->role->id == 2) {
            return [
                ...
                'data-pt-title'=>"Fungsi tombol ini untuk re akumulasi biaya produksi lain - lain.",
                'data-pt-size'=>"small",
    ...
    {
        return $this->dataType->slug == 'account-mtc';
    }
