...
class ActionLabor extends AbstractAction
{
    ...
    public function getAttributes()
    {
        ...
        // if(Auth::user()->role->id == 3 || Auth::user()->role->id == 1 || Auth::user()->role->id == 2) {
            return [
                ...
                'data-pt-title'=>"Fungsi tombol ini untuk re akumulasi biaya labor.",
                'data-pt-size'=>"small",
    ...
    {
        return $this->dataType->slug == 'labor';
    }
        ...
        if($this->data->ended_at == null){
            ...
            $redirect = redirect()->back();
                return $redirect->with([
                    'message'    => __('Informasi transaksi labor, data yang telah diclosed. tidak bisa diedit maupun direkakulasi ulang.'),
                    'alert-type' => 'info',
                ]);
