...
class ActionLocationMachineEdit extends AbstractAction
{
    ...
    public function getAttributes()
    {
        ...
        // if(Auth::user()->role->id == 3 || Auth::user()->role->id == 1 || Auth::user()->role->id == 2) {
            return [
                ...
                'data-pt-title'=>"Fungsi tombol ini mengubah data lokasi mesin.",
                'data-pt-size'=>"small",
    ...
    {
        return $this->dataType->slug == 'location-machine';
    }
