...
class ActionMTC extends AbstractAction
{
    ...
    public function getAttributes()
    {
        ...
        // if(Auth::user()->role->id == 3 || Auth::user()->role->id == 1 || Auth::user()->role->id == 2) {
            return [
                ...
                'data-pt-title'=>"Fungsi tombol ini untuk re akumulasi data mtc.",
                'data-pt-size'=>"small",
    ...
    {
        return $this->dataType->slug == 'rpt-mtc';
    }
        ...
        if($this->data->ended_at == null){
            ...
            $redirect = redirect()->back();
                return $redirect->with([
                    'message'    => __('Informasi transaksi MTC, data yang telah diclosed. tidak bisa diedit maupun direkakulasi ulang.'),
                    'alert-type' => 'info',
                ]);
